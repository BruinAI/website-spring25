            ...
            <div className="sticky top-20 right-12 md:right-16 max-w-[30vw] pr-2 sm:pr-8 z-10 flex items-start mt-16 float-right">
                <div className="text-left">
                    ...
                    <div className="relative ml-0 mt-10 md:ml-5">
                        ...
                        <Link 
                          to="/events" 
                          className="inline-flex items-center px-6 py-2 bg-gradient-to-r from-[#7069EC]/40 to-[#EE78D0]/40 text-white font-medium rounded-full text-xs sm:text-sm md:text-md hover:from-[#5a54d4]/60 hover:to-[#d665b8]/60 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                        >
                          see more
